...
// TODO: explain why no Bug#20574628 fixes in MDEV-13073 patch
...
// todo: check whether we need fixes for Bug#15985893: GTID SKIPPED EVENTS ON MASTER 
...
// MERGE> Aren't the semisync methods scrapped now?
#if 0
